...
- L'entourage (`jury`) doit, à l'inscription ou au premier vote, **déclarer son lien** avec un joueur (champ texte libre + référence au joueur : ex. « Mère de Raphaël »).
...
participants                -- qui peut voter à cette édition et comment
  ...
  relation_label (text, requis si kind=jury)  -- ex "Mère de Raphaël"
